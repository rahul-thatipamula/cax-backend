...
public class AuthService {
    ...
    public AuthService(UserRepository userRepository, CollegeRepository collegeRepository, JwtUtil jwtUtil, GoogleIdTokenVerifier googleIdTokenVerifier) {
    ...
    public Map<String, Object> handleGoogleLoginOrSignup(String googleIdTokenStr) {
        try {
            ...
            log.error("Google login/signup failed: ", e);
            throw new AuthException.InvalidTokenException("Google ID token verification failed");
        }
    }
